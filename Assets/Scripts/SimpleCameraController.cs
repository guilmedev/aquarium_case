    ...
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        private void ShotRay()
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                var aquariumScript = objectHit.GetComponentInParent<Aquarium>();
                
                if (aquariumScript!= null)
                {
                    aquariumScript.SetHit(hit);
                }
            }
        }
        ...
        {
#if ENABLE_INPUT_SYSTEM
            return Mouse.current != null ? Mouse.current.IsLeftMouseButtonDown.isPressed : false;
#else
